...
public class ChangeAppearance extends JDialog implements ActionListener
{
	...
	private final JRadioButton[] decks = new JRadioButton[NUM_DECKS];

	private final JRadioButton[] backgrounds = new JRadioButton[NUM_BACKGROUNDS];

	private final JButton ok = new JButton("Choose This Setup");
	...
	private final JLabel cardBackLabel = new JLabel();
	...
	private void setup()
	{
		...
		cardBackLabel.setIcon(new ImageIcon(this.getClass().getResource("images/cardbacks/cardback" + deckNumber + ".png")));
		JPanel cardBackViewer = new JPanel();
		cardBackViewer.add(cardBackLabel);

		backgroundLabel.setIcon(new ImageIcon(this.getClass().getResource("images/backgrounds/background" + backgroundNumber + "small.jpg")));
