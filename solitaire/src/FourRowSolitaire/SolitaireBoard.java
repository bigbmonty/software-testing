...
public class SolitaireBoard extends JFrame
{
	...
	private void recordGame(int winOrLoss)
	{
		...
		try
		{
			...
			output.writeInt(checkForUpdates);
	...
	private class MyMouseListener extends MouseInputAdapter
	{
		...
		private void checkWin()
		{
			...
			if(timerToRun)
			{
				final TopTimes top = new TopTimes(SolitaireBoard.this);
			...
			if(winAnimationStatus != 0 || winSoundsStatus != 0)
			{
				...
				winScreen = new WinScreen(winAnimationStatus, winSoundsStatus);
			}
		...
		public void mousePressed(MouseEvent e)
		{
			...
			{
				if(e.getSource() == discardPile && (discardPile.getNumViewableCards() == 1 ||
					(discardPile.getNumViewableCards() == 0 && !discardPile.isEmpty())))
				{
				...
				else if(e.getSource() instanceof Column)
				{
					...
					tempCard = col.previewCard(e.getPoint());
					rightClicked = true;
				}
			}
		}
		...
		{
			if(SwingUtilities.isRightMouseButton(e) && tempCard != null)
			{
		...
		public void mouseClicked(MouseEvent e)
		{
			...
			if(!SwingUtilities.isLeftMouseButton(e) || rightClicked)
			{
				return;
			}
