...
public class ChangeOptions extends JDialog implements ActionListener
{
	...
	private final JRadioButton drawOne = new JRadioButton("Draw One");
	private final JRadioButton drawThree = new JRadioButton("Draw Three");

	private final JCheckBox timerCheck = new JCheckBox("Timer");
	private int timer = 0; //0 = off, 1 = on

	private final JCheckBox winAnimationCheck = new JCheckBox("Win Animation");
	private int animation = 0; //0 = off, 1 = on
	private final JCheckBox winSoundsCheck = new JCheckBox("Win Sounds");
	...
	private final JButton ok = new JButton("Accept Options");
	...
	private void setup()
	{
		...
		if(drawCount == 3)
		{
			...
			easy.setToolTipText("4 times through deck");
			medium.setToolTipText("3 times through deck");
			hard.setToolTipText("2 times through deck");
		}
		else
		{
			drawOne.setSelected(true);
			easy.setToolTipText("3 times through deck");
			medium.setToolTipText("2 times through deck");
			hard.setToolTipText("1 time through deck");
		}
